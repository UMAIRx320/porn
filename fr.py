...
for xd in range(10000):
	...
	k='Chrome/94.0.4606.85 Mobile Safari/537.36'
	...
	l='Chrome/106.0.0.0 Mobile Safari/537.36'
...
for x in range(10):
	...
	i='Sony Xperia Z3 Build/KOT49H)'
	j=random.randrange(1, 9)
	k=random.randrange(1, 9)
	l='AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/30.0.0.0 Mobile Safari/537.36 bdbrowser/1.9.0.2'
...
def ceker(idf,pw):
	global cp
	ua = 'Mozilla/5.0 (Linux; U; Android 11.0.0; Xperia XZ3 Build/H9436) AppleWebKit/534.31 (KHTML, like Gecko) Version/4.0 UCBrowser/13.3.8.1305 U3/0.8.0 Mobile Safari/534.31'
...
def cek_opsi():
	...
	for kes in akun:
		try:
			...
			ua = 'Mozilla/5.0 (Linux; Android 9; OnePlus 7 PRO) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3795.0 Mobile Safari/537.36'
			ses = requests.Session()
